            ...
            parsers: G = {
                ...
                mediaFeature: function() {
                    var b, c, d = this.entities,
                        e = [];
                    do if (b = d.keyword() || d.variable()) e.push(b);
                    else if (j("(")) {
                ...
                value: function() {
                    var a, b = [];
                    do if (a = this.expression(), a && (b.push(a), !j(","))) break;
                    while (a);
    ...
    function(a) {
        a.Ruleset = function(a, b, c) {
            ...
            eval: function(b) {
                ...
                var h, i, j = this.rules ? this.rules.slice(0) : null,
                    k = new a.Ruleset(c, j, this.strictImports);
